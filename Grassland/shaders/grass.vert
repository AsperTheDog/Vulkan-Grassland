...
layout(location = 2) in float inInstanceHeight;

layout(location = 3) in vec2 vertexPosition;  // Vertex positions
layout(location = 4) in vec2 vertexNormal;    // Vertex normals
layout(location = 5) in vec3 vertexColor;     // Vertex colors
